...
class LeggedRobotWithArmModeSequenceKeyboard {
    public:
        LeggedRobotWithArmModeSequenceKeyboard(ros::NodeHandle nodeHandle, const std::string& gaitFile, const std::string& robotName,
                                               bool verbose = false);
