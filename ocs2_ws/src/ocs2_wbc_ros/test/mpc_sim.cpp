...
int main(int argc, char* argv[]) {
  ...
  auto mpc = std::make_unique<ocs2::SqpMpc>(interfacePtr->mpcSettings(), interfacePtr->sqpSettings(), 
  ...
  auto rosReferenceManagerPtr = std::make_shared<ocs2::RosReferenceManager>(robotName, interfacePtr->getSwitchedModelReferenceManagerPtr());
