...
#include <x20_robcogen/inverse_dynamics.h>
#include <x20_robcogen/jsim.h>
...
private:
    X20::rcg::InertiaProperties inertia_prop_;
    X20::rcg::MotionTransforms motion_transf_;
    X20::rcg::ForceTransforms force_transf_;
    X20::rcg::InverseDynamics inverse_dynamics_;
    X20::rcg::JSIM jsim_;
