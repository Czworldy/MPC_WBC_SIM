#ifndef RCG_X20_JSIM_H_
#define RCG_X20_JSIM_H_
...
/**
 * The type of the Joint Space Inertia Matrix (JSIM) of the robot X20.
 */
class JSIM : public iit::rbd::StateDependentMatrix<X20::rcg::JointState, 18, 18, JSIM>
{
    private:
        typedef iit::rbd::StateDependentMatrix<X20::rcg::JointState, 18, 18, JSIM> Base;
    public:
