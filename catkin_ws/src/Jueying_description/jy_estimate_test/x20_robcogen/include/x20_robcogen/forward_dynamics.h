#ifndef RCG_X20_FORWARD_DYNAMICS_H_
#define RCG_X20_FORWARD_DYNAMICS_H_
...
/**
 * The Forward Dynamics routine for the robot X20.
 *
...
public:
     ...
     *     the robot X20, which will be used by this instance
