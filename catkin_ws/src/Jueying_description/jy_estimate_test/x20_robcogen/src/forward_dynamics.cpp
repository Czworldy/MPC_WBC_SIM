...
const X20::rcg::ForwardDynamics::ExtForces
    X20::rcg::ForwardDynamics::zeroExtForces(Force::Zero());

X20::rcg::ForwardDynamics::ForwardDynamics(InertiaProperties& inertia, MotionTransforms& transforms) :
...
void X20::rcg::ForwardDynamics::fd(
    JointState& qdd,
    Acceleration& BASE_a,
