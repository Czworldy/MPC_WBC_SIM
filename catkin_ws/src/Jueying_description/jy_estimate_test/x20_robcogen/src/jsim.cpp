...
X20::rcg::JSIM::JSIM(InertiaProperties& inertiaProperties, ForceTransforms& forceTransforms) :
...
const X20::rcg::JSIM& X20::rcg::JSIM::update(const JointState& state) {
...
void X20::rcg::JSIM::computeInverse() {
    computeLInverse();
...
void X20::rcg::JSIM::computeLInverse() {
