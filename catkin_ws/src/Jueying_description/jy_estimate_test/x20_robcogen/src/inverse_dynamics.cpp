...
const X20::rcg::InverseDynamics::ExtForces
X20::rcg::InverseDynamics::zeroExtForces(Force::Zero());

X20::rcg::InverseDynamics::InverseDynamics(InertiaProperties& inertia, MotionTransforms& transforms) :
...
{
#ifndef EIGEN_NO_DEBUG
    std::cout << "Robot X20, InverseDynamics::InverseDynamics()" << std::endl;
...
void X20::rcg::InverseDynamics::id(
...
void X20::rcg::InverseDynamics::G_terms_fully_actuated(
...
void X20::rcg::InverseDynamics::C_terms_fully_actuated(
    Force& baseWrench, JointState& jForces,
...
void X20::rcg::InverseDynamics::id_fully_actuated(
        Force& baseWrench, JointState& jForces,
...
void X20::rcg::InverseDynamics::secondPass_fullyActuated(JointState& jForces)
{
    // Link 'RH_SHANK'
