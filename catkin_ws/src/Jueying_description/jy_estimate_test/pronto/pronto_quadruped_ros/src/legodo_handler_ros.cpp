...
LegodoHandlerBase::Update* LegodoHandlerBase::computeVelocity(){
  if(debug_){
      ...
      ROS_INFO_STREAM("STANCE_MSG_LF: "<< stance_msg_.lf);
      ROS_INFO_STREAM("STANCE_MSG_RF: "<< stance_msg_.rf);
      ROS_INFO_STREAM("STANCE_MSG_LH: "<< stance_msg_.lh);
      ROS_INFO_STREAM("STANCE_MSG_RH: "<< stance_msg_.rh);
      ...
      prior_joint_accel_msg.position ={q_(0), q_( 1), q_( 2),
                                       q_(3), q_( 4), q_( 5),
                                       q_(6), q_( 7), q_( 8),
                                       q_(9), q_(10), q_(11)};
      prior_joint_accel_msg.velocity ={qd_(0), qd_( 1), qd_( 2),
                                       qd_(3), qd_( 4), qd_( 5),
                                       qd_(6), qd_( 7), qd_( 8),
                                       qd_(9), qd_(10), qd_(11)};
      // qdd_, xd_, xdd_, omega_, omegad_
      prior_joint_accel_msg.effort = {tau_(0), tau_( 1), tau_( 2),
                                      tau_(3), tau_( 4), tau_( 5),
                                      tau_(6), tau_( 7), tau_( 8),
                                      tau_(9), tau_(10), tau_(11)};
