 ...
 * @date July 2005
 */
Eigen::Vector3d inline quatToOmega(Eigen::Quaterniond q, Eigen::Quaterniond qd)
{
 ...
 */
inline Eigen::Quaterniond  rotMatToQuat(const Eigen::Matrix3d & R) {
 ...
 * @return
 */
inline Eigen::Quaterniond computeOrientError(const Eigen::Quaterniond& q_des,
 ...
 * @sa quatL()
 */
inline Eigen::Matrix<double,4,4> quatR(const Eigen::Quaterniond& q) {
 ...
 * @sa quatR()
 */
inline Eigen::Matrix<double,4,4> quatL(const Eigen::Quaterniond & q){
    Eigen::Matrix<double,4,4> M;
 ...
 */
inline Eigen::Vector3d quatToRotVec(const Eigen::Quaterniond & q){
    Eigen::Vector3d v;
    const double c = q.w();
    v = q.vec();
 ...
 */
inline Eigen::Quaterniond rotVecToQuat(const Eigen::Vector3d& v){
    Eigen::Quaterniond q;
