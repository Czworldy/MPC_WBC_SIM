...
#include <pronto_jypro_commons/feet_contact_forces.hpp>
...
int main(int argc, char** argv) {
    ros::init(argc, argv, "pronto_jypro_node");
    std::string prefix = "/state_estimator_pronto";
    ros::NodeHandle nh(prefix);

    JYPro::rcg::FeetContactForces feet_forces;
    JYPro::rcg::FeetJacobians feet_jacs;
    JYPro::rcg::ForwardKinematics fwd_kin;
