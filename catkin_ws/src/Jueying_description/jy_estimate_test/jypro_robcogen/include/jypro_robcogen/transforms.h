#ifndef JYPRO_TRANSFORMS_H_
#define JYPRO_TRANSFORMS_H_
...
public:
    ...
    struct Type_fr_BASE_X_fr_LF_FOOT : public TransformMotion<Type_fr_BASE_X_fr_LF_FOOT>
    {
        Type_fr_BASE_X_fr_LF_FOOT();
        const Type_fr_BASE_X_fr_LF_FOOT& update(const state_t&);
    };
    
    struct Type_fr_BASE_X_fr_RF_FOOT : public TransformMotion<Type_fr_BASE_X_fr_RF_FOOT>
    {
        Type_fr_BASE_X_fr_RF_FOOT();
        const Type_fr_BASE_X_fr_RF_FOOT& update(const state_t&);
    };
    
    struct Type_fr_BASE_X_fr_LH_FOOT : public TransformMotion<Type_fr_BASE_X_fr_LH_FOOT>
    {
        Type_fr_BASE_X_fr_LH_FOOT();
        const Type_fr_BASE_X_fr_LH_FOOT& update(const state_t&);
    };
    
    struct Type_fr_BASE_X_fr_RH_FOOT : public TransformMotion<Type_fr_BASE_X_fr_RH_FOOT>
    {
        Type_fr_BASE_X_fr_RH_FOOT();
        const Type_fr_BASE_X_fr_RH_FOOT& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_LF_FOOT : public TransformMotion<Type_fr_imu_link_X_fr_LF_FOOT>
    {
        Type_fr_imu_link_X_fr_LF_FOOT();
        const Type_fr_imu_link_X_fr_LF_FOOT& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_RF_FOOT : public TransformMotion<Type_fr_imu_link_X_fr_RF_FOOT>
    {
        Type_fr_imu_link_X_fr_RF_FOOT();
        const Type_fr_imu_link_X_fr_RF_FOOT& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_LH_FOOT : public TransformMotion<Type_fr_imu_link_X_fr_LH_FOOT>
    {
        Type_fr_imu_link_X_fr_LH_FOOT();
        const Type_fr_imu_link_X_fr_LH_FOOT& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_RH_FOOT : public TransformMotion<Type_fr_imu_link_X_fr_RH_FOOT>
    {
        Type_fr_imu_link_X_fr_RH_FOOT();
        const Type_fr_imu_link_X_fr_RH_FOOT& update(const state_t&);
    };
    ...
    struct Type_fr_imu_link_X_fr_LF_HAA : public TransformMotion<Type_fr_imu_link_X_fr_LF_HAA>
    {
        Type_fr_imu_link_X_fr_LF_HAA();
        const Type_fr_imu_link_X_fr_LF_HAA& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_LF_HFE : public TransformMotion<Type_fr_imu_link_X_fr_LF_HFE>
    {
        Type_fr_imu_link_X_fr_LF_HFE();
        const Type_fr_imu_link_X_fr_LF_HFE& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_LF_KFE : public TransformMotion<Type_fr_imu_link_X_fr_LF_KFE>
    {
        Type_fr_imu_link_X_fr_LF_KFE();
        const Type_fr_imu_link_X_fr_LF_KFE& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_RF_HAA : public TransformMotion<Type_fr_imu_link_X_fr_RF_HAA>
    {
        Type_fr_imu_link_X_fr_RF_HAA();
        const Type_fr_imu_link_X_fr_RF_HAA& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_RF_HFE : public TransformMotion<Type_fr_imu_link_X_fr_RF_HFE>
    {
        Type_fr_imu_link_X_fr_RF_HFE();
        const Type_fr_imu_link_X_fr_RF_HFE& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_RF_KFE : public TransformMotion<Type_fr_imu_link_X_fr_RF_KFE>
    {
        Type_fr_imu_link_X_fr_RF_KFE();
        const Type_fr_imu_link_X_fr_RF_KFE& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_LH_HAA : public TransformMotion<Type_fr_imu_link_X_fr_LH_HAA>
    {
        Type_fr_imu_link_X_fr_LH_HAA();
        const Type_fr_imu_link_X_fr_LH_HAA& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_LH_HFE : public TransformMotion<Type_fr_imu_link_X_fr_LH_HFE>
    {
        Type_fr_imu_link_X_fr_LH_HFE();
        const Type_fr_imu_link_X_fr_LH_HFE& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_LH_KFE : public TransformMotion<Type_fr_imu_link_X_fr_LH_KFE>
    {
        Type_fr_imu_link_X_fr_LH_KFE();
        const Type_fr_imu_link_X_fr_LH_KFE& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_RH_HAA : public TransformMotion<Type_fr_imu_link_X_fr_RH_HAA>
    {
        Type_fr_imu_link_X_fr_RH_HAA();
        const Type_fr_imu_link_X_fr_RH_HAA& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_RH_HFE : public TransformMotion<Type_fr_imu_link_X_fr_RH_HFE>
    {
        Type_fr_imu_link_X_fr_RH_HFE();
        const Type_fr_imu_link_X_fr_RH_HFE& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_RH_KFE : public TransformMotion<Type_fr_imu_link_X_fr_RH_KFE>
    {
        Type_fr_imu_link_X_fr_RH_KFE();
        const Type_fr_imu_link_X_fr_RH_KFE& update(const state_t&);
    };
...
public:
    ...
    Type_fr_imu_link_X_fr_LF_FOOT fr_imu_link_X_fr_LF_FOOT;
    Type_fr_imu_link_X_fr_RF_FOOT fr_imu_link_X_fr_RF_FOOT;
    Type_fr_imu_link_X_fr_LH_FOOT fr_imu_link_X_fr_LH_FOOT;
    Type_fr_imu_link_X_fr_RH_FOOT fr_imu_link_X_fr_RH_FOOT;
    ...
    Type_fr_imu_link_X_fr_LF_HAA fr_imu_link_X_fr_LF_HAA;
    Type_fr_imu_link_X_fr_LF_HFE fr_imu_link_X_fr_LF_HFE;
    Type_fr_imu_link_X_fr_LF_KFE fr_imu_link_X_fr_LF_KFE;
    Type_fr_imu_link_X_fr_RF_HAA fr_imu_link_X_fr_RF_HAA;
    Type_fr_imu_link_X_fr_RF_HFE fr_imu_link_X_fr_RF_HFE;
    Type_fr_imu_link_X_fr_RF_KFE fr_imu_link_X_fr_RF_KFE;
    Type_fr_imu_link_X_fr_LH_HAA fr_imu_link_X_fr_LH_HAA;
    Type_fr_imu_link_X_fr_LH_HFE fr_imu_link_X_fr_LH_HFE;
    Type_fr_imu_link_X_fr_LH_KFE fr_imu_link_X_fr_LH_KFE;
    Type_fr_imu_link_X_fr_RH_HAA fr_imu_link_X_fr_RH_HAA;
    Type_fr_imu_link_X_fr_RH_HFE fr_imu_link_X_fr_RH_HFE;
    Type_fr_imu_link_X_fr_RH_KFE fr_imu_link_X_fr_RH_KFE;
...
public:
    ...
    struct Type_fr_BASE_X_fr_LF_FOOT : public TransformForce<Type_fr_BASE_X_fr_LF_FOOT>
    {
        Type_fr_BASE_X_fr_LF_FOOT();
        const Type_fr_BASE_X_fr_LF_FOOT& update(const state_t&);
    };
    
    struct Type_fr_BASE_X_fr_RF_FOOT : public TransformForce<Type_fr_BASE_X_fr_RF_FOOT>
    {
        Type_fr_BASE_X_fr_RF_FOOT();
        const Type_fr_BASE_X_fr_RF_FOOT& update(const state_t&);
    };
    
    struct Type_fr_BASE_X_fr_LH_FOOT : public TransformForce<Type_fr_BASE_X_fr_LH_FOOT>
    {
        Type_fr_BASE_X_fr_LH_FOOT();
        const Type_fr_BASE_X_fr_LH_FOOT& update(const state_t&);
    };
    
    struct Type_fr_BASE_X_fr_RH_FOOT : public TransformForce<Type_fr_BASE_X_fr_RH_FOOT>
    {
        Type_fr_BASE_X_fr_RH_FOOT();
        const Type_fr_BASE_X_fr_RH_FOOT& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_LF_FOOT : public TransformForce<Type_fr_imu_link_X_fr_LF_FOOT>
    {
        Type_fr_imu_link_X_fr_LF_FOOT();
        const Type_fr_imu_link_X_fr_LF_FOOT& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_RF_FOOT : public TransformForce<Type_fr_imu_link_X_fr_RF_FOOT>
    {
        Type_fr_imu_link_X_fr_RF_FOOT();
        const Type_fr_imu_link_X_fr_RF_FOOT& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_LH_FOOT : public TransformForce<Type_fr_imu_link_X_fr_LH_FOOT>
    {
        Type_fr_imu_link_X_fr_LH_FOOT();
        const Type_fr_imu_link_X_fr_LH_FOOT& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_RH_FOOT : public TransformForce<Type_fr_imu_link_X_fr_RH_FOOT>
    {
        Type_fr_imu_link_X_fr_RH_FOOT();
        const Type_fr_imu_link_X_fr_RH_FOOT& update(const state_t&);
    };
    ...
    struct Type_fr_imu_link_X_fr_LF_HAA : public TransformForce<Type_fr_imu_link_X_fr_LF_HAA>
    {
        Type_fr_imu_link_X_fr_LF_HAA();
        const Type_fr_imu_link_X_fr_LF_HAA& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_LF_HFE : public TransformForce<Type_fr_imu_link_X_fr_LF_HFE>
    {
        Type_fr_imu_link_X_fr_LF_HFE();
        const Type_fr_imu_link_X_fr_LF_HFE& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_LF_KFE : public TransformForce<Type_fr_imu_link_X_fr_LF_KFE>
    {
        Type_fr_imu_link_X_fr_LF_KFE();
        const Type_fr_imu_link_X_fr_LF_KFE& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_RF_HAA : public TransformForce<Type_fr_imu_link_X_fr_RF_HAA>
    {
        Type_fr_imu_link_X_fr_RF_HAA();
        const Type_fr_imu_link_X_fr_RF_HAA& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_RF_HFE : public TransformForce<Type_fr_imu_link_X_fr_RF_HFE>
    {
        Type_fr_imu_link_X_fr_RF_HFE();
        const Type_fr_imu_link_X_fr_RF_HFE& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_RF_KFE : public TransformForce<Type_fr_imu_link_X_fr_RF_KFE>
    {
        Type_fr_imu_link_X_fr_RF_KFE();
        const Type_fr_imu_link_X_fr_RF_KFE& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_LH_HAA : public TransformForce<Type_fr_imu_link_X_fr_LH_HAA>
    {
        Type_fr_imu_link_X_fr_LH_HAA();
        const Type_fr_imu_link_X_fr_LH_HAA& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_LH_HFE : public TransformForce<Type_fr_imu_link_X_fr_LH_HFE>
    {
        Type_fr_imu_link_X_fr_LH_HFE();
        const Type_fr_imu_link_X_fr_LH_HFE& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_LH_KFE : public TransformForce<Type_fr_imu_link_X_fr_LH_KFE>
    {
        Type_fr_imu_link_X_fr_LH_KFE();
        const Type_fr_imu_link_X_fr_LH_KFE& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_RH_HAA : public TransformForce<Type_fr_imu_link_X_fr_RH_HAA>
    {
        Type_fr_imu_link_X_fr_RH_HAA();
        const Type_fr_imu_link_X_fr_RH_HAA& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_RH_HFE : public TransformForce<Type_fr_imu_link_X_fr_RH_HFE>
    {
        Type_fr_imu_link_X_fr_RH_HFE();
        const Type_fr_imu_link_X_fr_RH_HFE& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_RH_KFE : public TransformForce<Type_fr_imu_link_X_fr_RH_KFE>
    {
        Type_fr_imu_link_X_fr_RH_KFE();
        const Type_fr_imu_link_X_fr_RH_KFE& update(const state_t&);
    };
...
public:
    ...
    struct Type_fr_BASE_X_fr_LF_FOOT : public TransformHomogeneous<Type_fr_BASE_X_fr_LF_FOOT>
    {
        Type_fr_BASE_X_fr_LF_FOOT();
        const Type_fr_BASE_X_fr_LF_FOOT& update(const state_t&);
    };
    
    struct Type_fr_BASE_X_fr_RF_FOOT : public TransformHomogeneous<Type_fr_BASE_X_fr_RF_FOOT>
    {
        Type_fr_BASE_X_fr_RF_FOOT();
        const Type_fr_BASE_X_fr_RF_FOOT& update(const state_t&);
    };
    
    struct Type_fr_BASE_X_fr_LH_FOOT : public TransformHomogeneous<Type_fr_BASE_X_fr_LH_FOOT>
    {
        Type_fr_BASE_X_fr_LH_FOOT();
        const Type_fr_BASE_X_fr_LH_FOOT& update(const state_t&);
    };
    
    struct Type_fr_BASE_X_fr_RH_FOOT : public TransformHomogeneous<Type_fr_BASE_X_fr_RH_FOOT>
    {
        Type_fr_BASE_X_fr_RH_FOOT();
        const Type_fr_BASE_X_fr_RH_FOOT& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_LF_FOOT : public TransformHomogeneous<Type_fr_imu_link_X_fr_LF_FOOT>
    {
        Type_fr_imu_link_X_fr_LF_FOOT();
        const Type_fr_imu_link_X_fr_LF_FOOT& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_RF_FOOT : public TransformHomogeneous<Type_fr_imu_link_X_fr_RF_FOOT>
    {
        Type_fr_imu_link_X_fr_RF_FOOT();
        const Type_fr_imu_link_X_fr_RF_FOOT& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_LH_FOOT : public TransformHomogeneous<Type_fr_imu_link_X_fr_LH_FOOT>
    {
        Type_fr_imu_link_X_fr_LH_FOOT();
        const Type_fr_imu_link_X_fr_LH_FOOT& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_RH_FOOT : public TransformHomogeneous<Type_fr_imu_link_X_fr_RH_FOOT>
    {
        Type_fr_imu_link_X_fr_RH_FOOT();
        const Type_fr_imu_link_X_fr_RH_FOOT& update(const state_t&);
    };
    ...
    struct Type_fr_imu_link_X_fr_LF_HAA : public TransformHomogeneous<Type_fr_imu_link_X_fr_LF_HAA>
    {
        Type_fr_imu_link_X_fr_LF_HAA();
        const Type_fr_imu_link_X_fr_LF_HAA& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_LF_HFE : public TransformHomogeneous<Type_fr_imu_link_X_fr_LF_HFE>
    {
        Type_fr_imu_link_X_fr_LF_HFE();
        const Type_fr_imu_link_X_fr_LF_HFE& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_LF_KFE : public TransformHomogeneous<Type_fr_imu_link_X_fr_LF_KFE>
    {
        Type_fr_imu_link_X_fr_LF_KFE();
        const Type_fr_imu_link_X_fr_LF_KFE& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_RF_HAA : public TransformHomogeneous<Type_fr_imu_link_X_fr_RF_HAA>
    {
        Type_fr_imu_link_X_fr_RF_HAA();
        const Type_fr_imu_link_X_fr_RF_HAA& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_RF_HFE : public TransformHomogeneous<Type_fr_imu_link_X_fr_RF_HFE>
    {
        Type_fr_imu_link_X_fr_RF_HFE();
        const Type_fr_imu_link_X_fr_RF_HFE& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_RF_KFE : public TransformHomogeneous<Type_fr_imu_link_X_fr_RF_KFE>
    {
        Type_fr_imu_link_X_fr_RF_KFE();
        const Type_fr_imu_link_X_fr_RF_KFE& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_LH_HAA : public TransformHomogeneous<Type_fr_imu_link_X_fr_LH_HAA>
    {
        Type_fr_imu_link_X_fr_LH_HAA();
        const Type_fr_imu_link_X_fr_LH_HAA& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_LH_HFE : public TransformHomogeneous<Type_fr_imu_link_X_fr_LH_HFE>
    {
        Type_fr_imu_link_X_fr_LH_HFE();
        const Type_fr_imu_link_X_fr_LH_HFE& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_LH_KFE : public TransformHomogeneous<Type_fr_imu_link_X_fr_LH_KFE>
    {
        Type_fr_imu_link_X_fr_LH_KFE();
        const Type_fr_imu_link_X_fr_LH_KFE& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_RH_HAA : public TransformHomogeneous<Type_fr_imu_link_X_fr_RH_HAA>
    {
        Type_fr_imu_link_X_fr_RH_HAA();
        const Type_fr_imu_link_X_fr_RH_HAA& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_RH_HFE : public TransformHomogeneous<Type_fr_imu_link_X_fr_RH_HFE>
    {
        Type_fr_imu_link_X_fr_RH_HFE();
        const Type_fr_imu_link_X_fr_RH_HFE& update(const state_t&);
    };
    
    struct Type_fr_imu_link_X_fr_RH_KFE : public TransformHomogeneous<Type_fr_imu_link_X_fr_RH_KFE>
    {
        Type_fr_imu_link_X_fr_RH_KFE();
        const Type_fr_imu_link_X_fr_RH_KFE& update(const state_t&);
    };
