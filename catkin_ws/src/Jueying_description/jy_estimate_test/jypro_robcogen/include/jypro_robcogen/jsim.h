#ifndef RCG_JYPRO_JSIM_H_
#define RCG_JYPRO_JSIM_H_
...
/**
 * The type of the Joint Space Inertia Matrix (JSIM) of the robot JYPro.
 */
class JSIM : public iit::rbd::StateDependentMatrix<JYPro::rcg::JointState, 18, 18, JSIM>
{
    private:
        typedef iit::rbd::StateDependentMatrix<JYPro::rcg::JointState, 18, 18, JSIM> Base;
    public:
