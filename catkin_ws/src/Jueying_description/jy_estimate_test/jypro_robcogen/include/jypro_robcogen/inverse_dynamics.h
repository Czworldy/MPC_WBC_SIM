#ifndef RCG_JYPRO_INVERSE_DYNAMICS_H_
#define RCG_JYPRO_INVERSE_DYNAMICS_H_
...
/**
 * The Inverse Dynamics routine for the robot JYPro.
 *
...
public:
     ...
     *     the robot JYPro, which will be used by this instance
