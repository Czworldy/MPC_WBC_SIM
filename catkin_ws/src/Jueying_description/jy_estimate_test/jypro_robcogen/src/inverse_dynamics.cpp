...
const JYPro::rcg::InverseDynamics::ExtForces
JYPro::rcg::InverseDynamics::zeroExtForces(Force::Zero());

JYPro::rcg::InverseDynamics::InverseDynamics(InertiaProperties& inertia, MotionTransforms& transforms) :
...
{
#ifndef EIGEN_NO_DEBUG
    std::cout << "Robot JYPro, InverseDynamics::InverseDynamics()" << std::endl;
...
void JYPro::rcg::InverseDynamics::id(
...
void JYPro::rcg::InverseDynamics::G_terms_fully_actuated(
...
void JYPro::rcg::InverseDynamics::C_terms_fully_actuated(
    Force& baseWrench, JointState& jForces,
...
void JYPro::rcg::InverseDynamics::id_fully_actuated(
        Force& baseWrench, JointState& jForces,
...
void JYPro::rcg::InverseDynamics::secondPass_fullyActuated(JointState& jForces)
{
    // Link 'RH_SHANK'
