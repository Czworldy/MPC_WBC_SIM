...
JYPro::rcg::JSIM::JSIM(InertiaProperties& inertiaProperties, ForceTransforms& forceTransforms) :
...
const JYPro::rcg::JSIM& JYPro::rcg::JSIM::update(const JointState& state) {
...
void JYPro::rcg::JSIM::computeInverse() {
    computeLInverse();
...
void JYPro::rcg::JSIM::computeLInverse() {
