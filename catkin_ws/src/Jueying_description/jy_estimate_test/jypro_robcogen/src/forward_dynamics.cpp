...
const JYPro::rcg::ForwardDynamics::ExtForces
    JYPro::rcg::ForwardDynamics::zeroExtForces(Force::Zero());

JYPro::rcg::ForwardDynamics::ForwardDynamics(InertiaProperties& inertia, MotionTransforms& transforms) :
...
void JYPro::rcg::ForwardDynamics::fd(
    JointState& qdd,
    Acceleration& BASE_a,
