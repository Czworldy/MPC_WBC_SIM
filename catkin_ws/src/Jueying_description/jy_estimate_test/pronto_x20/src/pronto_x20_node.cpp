...
#include <pronto_x20_commons/feet_contact_forces.hpp>
...
int main(int argc, char** argv) {
    ros::init(argc, argv, "pronto_x20_node");
    std::string prefix = "/state_estimator_pronto";
    ros::NodeHandle nh(prefix);

    X20::rcg::FeetContactForces feet_forces;
    X20::rcg::FeetJacobians feet_jacs;
    X20::rcg::ForwardKinematics fwd_kin;
